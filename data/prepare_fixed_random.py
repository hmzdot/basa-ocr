...
FOREGROUND_COLORS = [ (0, 0, 0), (64, 64, 64), (0, 0, 128),
    (139, 0, 0),
    (0, 100, 0),
    (75, 0, 130),
]
...
if os.path.exists("data/fixed_words"):
    if input("data/fixed_words already exists. Overwrite? (y/n): ") == "y":
        shutil.rmtree("data/fixed_words")
